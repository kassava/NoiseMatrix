...
//		}
	...
	public static double maxMirerToBackgroundValue(int[][] byteArray) {
		DescriptiveStatistics stats = new DescriptiveStatistics();
...
//			calculateRing(byteArray, stats, 210, 210, r, r + ringWidth - 1, 1);
	...
	/**
	 * Like linearResolutionFor6Circles() with specified max mirer to background value.
	 * @param byteArray
	 * @param max
	 * @return
	 */
	public static double[] linearResolutionFor6Circles(int[][] byteArray, double max) {
